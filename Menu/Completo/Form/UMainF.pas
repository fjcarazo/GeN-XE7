...
begin
 ...
 if LoginOk <> True then
  ...
  begin
   ...
   if Permiso < 2 then CONTABILIDAD1.Visible:=False;
   if Permiso < 1 then
   begin
 ...
 FMainForm.caption:='DeGsoft GeN - ERP - ['+Empresa+'] - '+Licencia+' - [USUARIO: '+Usuario+'] MODULO COMPLETO';
end;
...
procedure TFMainForm.COMPRAS1Click(Sender: TObject);
begin
...
procedure TFMainForm.VENTAS1Click(Sender: TObject);
begin

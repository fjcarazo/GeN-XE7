...
begin
 ...
 if LoginOk <> True then
  ...
  begin
   ...
   if Permiso < 2 then Operaciones1.Visible:=False;
   if Permiso < 1 then Listados1.Visible:=False;
  end;
 FMainForm.caption:='DeGsoft GeN - ERP - ['+Empresa+'] - '+Licencia+' - [USUARIO: '+Usuario+'] - MENU COBRANZA';
end;

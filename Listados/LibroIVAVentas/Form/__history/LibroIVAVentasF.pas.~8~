...
uses
  ...
  Dialogs, DB, ImprimirDM, ComCtrls, StdCtrls, Buttons, ExtCtrls, DataModule, Grids, DBGrids, IBCustomDataSet, IBQuery,
...
'  "LibroIVAventa".CODIGO,  '+
'  "LibroIVAventa".FECHA,    '+
'  "LibroIVAventa".FACTURA,   '+
'  "LibroIVAventa".CLIENTE,  '+
'  "LibroIVAventa".CUIT,      '+
'  "LibroIVAventa".CONDICION, '+
'  "LibroIVAventa".NG1,      '+
'  "LibroIVAventa".NG2,      '+
'  "LibroIVAventa".NG3,     '+
'  "LibroIVAventa".IVA1,    '+
'  "LibroIVAventa".IVA2,    '+
'  "LibroIVAventa".IVA3,     '+
'  "LibroIVAventa".OEIIBB,    '+
'  "LibroIVAventa".IDERPYPAC,  '+
'  "LibroIVAventa".ITF     '+
'FROM                    '+
'  "LibroIVAventa"    '+
'WHERE                '+

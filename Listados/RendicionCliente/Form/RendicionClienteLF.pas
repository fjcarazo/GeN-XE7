...
uses
  ...
  Dialogs, DB, ADODB, ComCtrls, StdCtrls, Buttons, ExtCtrls, DataModule, Grids, DBGrids, IBCustomDataSet, IBQuery,
...
procedure TRendicionClienteLForm.BuscarPlanProcesadoBitBtnClick(Sender: TObject);
begin

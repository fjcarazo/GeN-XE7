...
begin
  ...
  begin
    ...
    if CheckBox1.Checked then // Carga la hoja de cálculo recien creada
    begin

      ShellExecute(Handle, nil, PChar(aa), '', '', SW_SHOWNORMAL);

      ShowMessage('La hoja de cálculo ha sido creada y se está cargando.');

    end
    else
    begin
      ShowMessage('La hoja de cálculo ha sido creada.' + #13 + #13 +

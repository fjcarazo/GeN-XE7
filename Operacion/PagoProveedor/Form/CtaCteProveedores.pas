...
uses
  ...
  Dialogs, DB, Grids, DBGrids, StdCtrls, Buttons, Mask, DBCtrls, ExtCtrls, DataModule,
...
begin
 ...
 try
  ...
  OperacionDataModule.CtaCte('PROVEEDOR',CodigoEdit.Text,CtaNombre,FFormaPago.Pagado,StrToFloat(FFormaPago.FECheque.Text),StrToFloat(FFormaPago.ChequeTerceroEdit.Text),StrToFloat(FFormaPago.FEContado.Text),StrToFloat(FFormaPago.FETarjeta.Text),FFormaPago.Saldo);
  FFormaPago.Free;
 end;

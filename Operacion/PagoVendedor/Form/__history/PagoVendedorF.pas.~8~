...
uses
  ...
  Dialogs, StdCtrls, ComCtrls, Grids, Buttons, DBGrids, DB, ImprimirDM, DataModule, ExtCtrls,
...
//CONTABILIDAD++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 if CheckBox1.Checked = True then
  begin
   ...
   ' WHERE "RendidoVendedor".CODIGO ='+Tabla.FieldByName('Codigo').AsString, 'PagoVendedor');

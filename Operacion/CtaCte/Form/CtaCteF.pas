...
FFormaPago.Valores(SubTotal, Impuesto, Total);
 try
  ...
  OperacionDataModule.CtaCte('CLIENTE',clienteEdit.Text,CtaNombre,FFormaPago.Pagado,StrToFloat(FFormaPago.FECheque.Text),StrToFloat(FFormaPago.ChequeTerceroEdit.Text),StrToFloat(FFormaPago.FEContado.Text),StrToFloat(FFormaPago.FETarjeta.Text),FFormaPago.Saldo);
  FFormaPago.Free;
 end;

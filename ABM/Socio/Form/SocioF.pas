 ...
 BuscaSocioForm:=TBuscaSocioForm.Create(self);
   try
      BuscaSocioForm.ShowModal;
         ...
         Tabla.Locate('CODIGO',(BuscaSocioForm.Tabla.FieldByName('CODIGO').AsString),[]);
      BuscaSocioForm.Free;
   end;
   DBEdit2.SetFocus;
end;
...
begin
 ...
 ImprimirDataModule.SImpr('SELECT * From "Socio" WHERE CODIGO='+CodigoDBEdit.Text, 'SociosDetalle');
